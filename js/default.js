...
function verifyPassword(){
  ...
  }else if (accPassword == "hudson_ic202" || accPassword == "hudson_ic202 ") {
    // proceed to next level two of security checks
    //hide show next security
    //account = 20;
    openThisAccount(".account-3");
  }else if (accPassword == "myers1vv_i404" || accPassword == "myers1vv_i404 ") {
    // proceed to next level two of security checks
    //hide show next security
    //account = 20;
    openThisAccount(".account-5");
  }else if (accPassword == "williams1_i404" || accPassword == "williams1_i404 ") {
    // proceed to next level two of security checks
    //hide show next security
    //account = 20;
